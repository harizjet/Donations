...
class ListAmphibians extends StatefulWidget {
  ListAmphibians({Key key}) : super(key: key);

  _ListAmphibians createState() => _ListAmphibians();
}

class _ListAmphibians extends State<ListAmphibians> {
  ...
  final List<Map> animalListAmphibians = [
    {
      "name": "Malayan Tiger",
            ...
            children: <Widget>[
              Container(
                ...
                child: ListView.builder(
                    itemCount: animalListAmphibians.length,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image:
                          NetworkImage(animalListAmphibians[index]['logoText']),
                      fit: BoxFit.fill),
                ),
              ),
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      animalListAmphibians[index]['name'],
                      style: TextStyle(
                        color: primary,
