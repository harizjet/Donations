...
class PhotoDetailHeader extends StatelessWidget {
  PhotoDetailHeader(this.photography);
  ...
  Widget build(BuildContext context) {
    ...
    return ArcBannerPhoto(photography.bannerUrl);
